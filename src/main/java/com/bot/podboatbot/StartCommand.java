...
public final class StartCommand extends AnonymizerCommand {
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] strings) {
        ...
        if (mAnonymouses.addAnonymous(new Anonymous(user, chat))) {
            log.info("User " + user.getId() + " is trying to execute " + getCommandIdentifier() + " the first time. Added to users' list.");
            ...
            log.log(Priority.INFO, "User " + user.getId() + " has already executed " + getCommandIdentifier() + " . Is he trying to do it one more time?");
